# RAG性能評価ダッシュボード 20260726-mac-short-postfix-contract9
...
|--:|--|--|--|--|--:|--:|--:|--:|--|--|
|1|Current compatible run|9ec0213cc4|afcddd845d|seq=default, explain=False, diag=basic, pure=False|9|9|0|0.954|INSUFFICIENT_N|PASS|

## Run 1: Current compatible run

- source/run_id: 20260726-mac-short-postfix-contract9
...
|--|--|--|--|--|--|--:|--:|--:|--:|--:|--:|--:|--:|--|--|--|
|ac-rag|6b7bb428e1|f26efbb61f|L|daemon|daemon|3|3|0|0|0.386|0.954|2.000|0.954|INSUFFICIENT_N|PASS|YES|
|incident-rag|7e3858deb3|f825401fbe|L|daemon|daemon|3|3|0|0|0.390|0.432|2.000|0.432|INSUFFICIENT_N|PASS|YES|
|rfc-full-20k-rag|c7f4fba2fc|7c2a9d6f17|L|daemon|daemon|3|3|0|0|0.445|0.688|2.000|0.688|INSUFFICIENT_N|PASS|YES|
...
|--|--|--|--|--:|--|--|
|MAC-AC-EXACT-P|ac-rag|L|daemon|0.954|ok|SOURCES.md|
|MAC-RFC-EXACT-P|rfc-full-20k-rag|L|daemon|0.688|ok|rfc10002.txt|
|MAC-RFC-EXACT-N|rfc-full-20k-rag|L|daemon|0.445|partial|rfc10002.txt|
|MAC-INC-EXACT-P|incident-rag|L|daemon|0.432|ok|ntsb_aviation_report_67438.pdf|
|MAC-RFC-NOHIT|rfc-full-20k-rag|L|daemon|0.406|partial|rfc10002.txt|
|MAC-INC-EXACT-N|incident-rag|L|daemon|0.390|partial|ntsb_aviation_report_67438.pdf|
|MAC-AC-NOHIT|ac-rag|L|daemon|0.386|partial|sample_global_cooling_temperature_memo.docx|
|MAC-AC-EXACT-N|ac-rag|L|daemon|0.378|partial|iea_2018_the_future_of_cooling.pdf|
|MAC-INC-NOHIT|incident-rag|L|daemon|0.374|partial|ntsb_aviation_report_67438.pdf|
