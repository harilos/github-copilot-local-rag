# RAG性能評価ダッシュボード 20260726-mac-short-coldwarm-ac
...
|--:|--|--|--|--|--:|--:|--:|--:|--|--|
|1|Current pure-profile|9ec0213cc4|73bb819724|seq=default, explain=False, diag=off, pure=True|2|0|2||INSUFFICIENT_N|NOT_RUN|

## Run 1: Current pure-profile

- source/run_id: 20260726-mac-short-coldwarm-ac
- git_commit: 9ec0213cc48eb5ca63dfbce46623f8b63dfd7dfa
- git_dirty: True
- worktree_fingerprint: 73bb81972413f6063e449c29517de714775e0d678f92986735d4e22e37321aca
...
- case_spec_fingerprint: a48eda249557a457fb158432c195ef6ca36bbcc5e7a51e15548b5243ddf1c382
...
|--|--|--|--|--|--|--:|--:|--:|--:|--:|--:|--:|--:|--|--|--|
|ac-rag|6b7bb428e1|f26efbb61f|H|daemon|daemon|2|0|2|2|||8.000||INSUFFICIENT_N|NOT_RUN|YES|
...
|全検索の正常完了率|FAIL|2|0|2|2|exit 0・JSON parse・payload errorなし|
|daemon first-attempt成功率|FAIL|2|0|2|2|fallback後の成功と分離|
|final user-visible成功率|FAIL|2|0|2|0|fallback後の最終結果|
|fallback rate|PASS|2|2|0|0|clean daemon runでは0|
|daemon build identity|UNVERIFIED|2|0|2|0|daemon応答code fingerprintと測定側を比較|
|diagnostics mode contract|NOT_RUN|0|0|0|0|応答実値と要求値を照合|
|daemon timeout rate|FAIL|2|0|2|2|limit=0.000%|
...
|outer deadline adherence|PASS|2|2|0|2|成功・失敗を問わずwall time ≤ 15.000 sec|
...
|Gate|N|Pass|Fail|
|--|--:|--:|--:|
|JSON stdout parse|2|0|2|
|stdout JSON purity|2|0|2|
...
|--|--|--|--|--:|--|--|
|AC_SEM_001|ac-rag|H|daemon|8.514|error||
|AC_SEM_001|ac-rag|H|daemon|8.454|error||
