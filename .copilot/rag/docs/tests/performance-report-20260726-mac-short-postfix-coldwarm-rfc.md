# RAG性能評価ダッシュボード 20260726-mac-short-postfix-coldwarm-rfc
...
|--:|--|--|--|--|--:|--:|--:|--:|--|--|
|1|Current pure-profile|9ec0213cc4|afcddd845d|seq=default, explain=False, diag=off, pure=True|2|2|0|0.417|INSUFFICIENT_N|PASS|

## Run 1: Current pure-profile

- source/run_id: 20260726-mac-short-postfix-coldwarm-rfc
...
|--|--|--|--|--|--|--:|--:|--:|--:|--:|--:|--:|--:|--|--|--|
|rfc-full-20k-rag|c7f4fba2fc|7c2a9d6f17|H|daemon|daemon|2|2|0|0|0.403|0.417|8.000|0.417|INSUFFICIENT_N|PASS|YES|
...
|--|--|--|--|--:|--|--|
|RFC_SEM_001|rfc-full-20k-rag|H|daemon|0.417|ok|rfc10026.txt|
|RFC_SEM_001|rfc-full-20k-rag|H|daemon|0.403|ok|rfc10026.txt|
