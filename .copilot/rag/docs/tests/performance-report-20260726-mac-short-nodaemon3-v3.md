# RAG性能評価ダッシュボード 20260726-mac-short-nodaemon3-v3
...
|--:|--|--|--|--|--:|--:|--:|--:|--|--|
|1|Current pure-profile|9ec0213cc4|a6c0d6f965|seq=default, explain=False, diag=off, pure=True|3|3|0|5.400|NOT_RUN|NOT_RUN|

## Run 1: Current pure-profile

- source/run_id: 20260726-mac-short-nodaemon3-v3
...
|--|--|--|--|--|--|--:|--:|--:|--:|--:|--:|--:|--:|--|--|--|
|ac-rag|6b7bb428e1|f26efbb61f|H|no-daemon|no-daemon|1|1|0|0|5.400|5.400|8.000|5.400|INSUFFICIENT_N|PASS|YES|
|incident-rag|7e3858deb3|f825401fbe|H|no-daemon|no-daemon|1|1|0|0|3.885|3.885|8.000|3.885|INSUFFICIENT_N|PASS|YES|
|rfc-full-20k-rag|c7f4fba2fc|7c2a9d6f17|H|no-daemon|no-daemon|1|1|0|0|4.107|4.107|8.000|4.107|INSUFFICIENT_N|PASS|YES|
...
|--|--|--|--|--:|--|--|
|AC_SEM_001|ac-rag|H|no-daemon|5.400|ok|sample_global_cooling_temperature_memo.docx|
|RFC_SEM_001|rfc-full-20k-rag|H|no-daemon|4.107|ok|rfc10026.txt|
|INC_SEM_001|incident-rag|H|no-daemon|3.885|ok|ntsb_aviation_report_67526.pdf|
