# RAG性能評価ダッシュボード 20260726-mac-short-coldwarm-rfc-clean
...
|--:|--|--|--|--|--:|--:|--:|--:|--|--|
|1|Current pure-profile|9ec0213cc4|a6c0d6f965|seq=default, explain=False, diag=off, pure=True|2|2|0|0.670|INSUFFICIENT_N|PASS|

## Run 1: Current pure-profile

- source/run_id: 20260726-mac-short-coldwarm-rfc-clean
...
|--|--|--|--|--|--|--:|--:|--:|--:|--:|--:|--:|--:|--|--|--|
|rfc-full-20k-rag|c7f4fba2fc|7c2a9d6f17|H|daemon|daemon|2|2|0|0|0.638|0.670|8.000|0.670|INSUFFICIENT_N|PASS|YES|
...
|--|--|--|--|--:|--|--|
|RFC_SEM_001|rfc-full-20k-rag|H|daemon|0.670|ok|rfc10026.txt|
|RFC_SEM_001|rfc-full-20k-rag|H|daemon|0.638|ok|rfc10026.txt|
