# RAG性能評価ダッシュボード 20260726-mac-short-coldwarm-ac-v2
...
|--:|--|--|--|--|--:|--:|--:|--:|--|--|
|1|Current pure-profile|9ec0213cc4|cd82614c79|seq=default, explain=False, diag=off, pure=True|2|2|0|0.995|INSUFFICIENT_N|PASS|

## Run 1: Current pure-profile

- source/run_id: 20260726-mac-short-coldwarm-ac-v2
...
|--|--|--|--|--|--|--:|--:|--:|--:|--:|--:|--:|--:|--|--|--|
|ac-rag|6b7bb428e1|f26efbb61f|H|daemon|daemon|2|2|0|0|0.844|0.995|8.000|0.995|INSUFFICIENT_N|PASS|YES|
...
|--|--|--|--|--:|--|--|
|AC_SEM_001|ac-rag|H|daemon|0.995|ok|sample_global_cooling_temperature_memo.docx|
|AC_SEM_001|ac-rag|H|daemon|0.844|ok|sample_global_cooling_temperature_memo.docx|
