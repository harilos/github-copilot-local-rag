# RAG性能評価ダッシュボード 20260726-mac-short-final-v4-coldwarm-incident
...
|--:|--|--|--|--|--:|--:|--:|--:|--|--|
|1|Current pure-profile|9ec0213cc4|0d54579cec|seq=default, explain=False, diag=off, pure=True|2|2|0|0.430|INSUFFICIENT_N|PASS|

## Run 1: Current pure-profile

- source/run_id: 20260726-mac-short-final-v4-coldwarm-incident
...
|--|--|--|--|--|--|--:|--:|--:|--:|--:|--:|--:|--:|--|--|--|
|incident-rag|7e3858deb3|f825401fbe|H|daemon|daemon|2|2|0|0|0.424|0.430|8.000|0.430|INSUFFICIENT_N|PASS|YES|
...
|--|--|--|--|--:|--|--|
|INC_SEM_001|incident-rag|H|daemon|0.430|ok|ntsb_aviation_report_67526.pdf|
|INC_SEM_001|incident-rag|H|daemon|0.424|ok|ntsb_aviation_report_67526.pdf|
