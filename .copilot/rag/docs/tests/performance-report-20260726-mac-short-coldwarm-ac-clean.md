# RAG性能評価ダッシュボード 20260726-mac-short-coldwarm-ac-clean
...
|--:|--|--|--|--|--:|--:|--:|--:|--|--|
|1|Current pure-profile|9ec0213cc4|a6c0d6f965|seq=default, explain=False, diag=off, pure=True|2|2|0|0.458|INSUFFICIENT_N|PASS|

## Run 1: Current pure-profile

- source/run_id: 20260726-mac-short-coldwarm-ac-clean
...
|--|--|--|--|--|--|--:|--:|--:|--:|--:|--:|--:|--:|--|--|--|
|ac-rag|6b7bb428e1|f26efbb61f|H|daemon|daemon|2|2|0|0|0.412|0.458|8.000|0.458|INSUFFICIENT_N|PASS|YES|
...
|--|--|--|--|--:|--|--|
|AC_SEM_001|ac-rag|H|daemon|0.458|ok|sample_global_cooling_temperature_memo.docx|
|AC_SEM_001|ac-rag|H|daemon|0.412|ok|sample_global_cooling_temperature_memo.docx|
