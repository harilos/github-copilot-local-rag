# RAG性能評価ダッシュボード 20260726-mac-short-final-coldwarm-rfc
...
|--:|--|--|--|--|--:|--:|--:|--:|--|--|
|1|Current pure-profile|9ec0213cc4|68d8c9ec00|seq=default, explain=False, diag=off, pure=True|2|2|0|0.618|INSUFFICIENT_N|PASS|

## Run 1: Current pure-profile

- source/run_id: 20260726-mac-short-final-coldwarm-rfc
...
- Python: 3.13.14
- db_hash/db_snapshot_hash: rfc-full-20k-rag=c7f4fba2fc/7c2a9d6f17
...
- case_spec_fingerprint: 7e8cfd9ac6e75372a783b3fb9821828ff9e5c7bbfbf4a566b807cffbb25c1841
...
|--|--|--|--|--|--|--:|--:|--:|--:|--:|--:|--:|--:|--|--|--|
|rfc-full-20k-rag|c7f4fba2fc|7c2a9d6f17|H|daemon|daemon|2|2|0|0|0.467|0.618|8.000|0.618|INSUFFICIENT_N|PASS|YES|
...
|--|--|--|--|--:|--|--|
|RFC_SEM_001|rfc-full-20k-rag|H|daemon|0.618|ok|rfc10026.txt|
|RFC_SEM_001|rfc-full-20k-rag|H|daemon|0.467|ok|rfc10026.txt|
