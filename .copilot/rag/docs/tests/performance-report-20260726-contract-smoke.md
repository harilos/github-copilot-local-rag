# RAG性能評価ダッシュボード 20260726-contract-smoke
...
|--:|--|--|--|--|--:|--:|--:|--:|--|--|
|1|Current compatible run|9ec0213cc4|8dcc5c0389|seq=default, explain=False, diag=basic, pure=False|2|2|0|0.838|PASS|PASS|

## Run 1: Current compatible run

- source/run_id: 20260726-contract-smoke
...
|--|--|--|--|--|--:|--:|--:|--:|--:|--:|--:|--:|--|--|--|
|ac-rag|6b7bb428e1|f26efbb61f|L|daemon|1|1|0|0|0.432|0.432|2.000|0.432|PASS|PASS|NO|
|ac-rag|6b7bb428e1|f26efbb61f|L|no-daemon|1|1|0|0|0.838|0.838|2.000|0.838|PASS|PASS|NO|
...
|no-daemon smoke|PASS|1|1|0|0|N=0はNOT_RUN|
|no-hit contract|PASS|2|2|0|0|通常contexts空・related_context隔離|
...
|No-hit contract|2|2|0|

### slowest searches

|case|db|profile|execution|latency sec|status|top1|
|--|--|--|--|--:|--|--|
|AC_EXACT_NEG_COLLISION_001|ac-rag|L|no-daemon|0.838|partial|sample_global_cooling_temperature_memo.docx|
|AC_EXACT_NEG_COLLISION_001|ac-rag|L|daemon|0.432|partial|sample_global_cooling_temperature_memo.docx|
