# RAG性能評価ダッシュボード 20260726-mac-short-final-contract9
...
|--:|--|--|--|--|--:|--:|--:|--:|--|--|
|1|Current compatible run|9ec0213cc4|68d8c9ec00|seq=default, explain=False, diag=basic, pure=False|9|9|0|0.878|INSUFFICIENT_N|PASS|

## Run 1: Current compatible run

- source/run_id: 20260726-mac-short-final-contract9
- git_commit: 9ec0213cc48eb5ca63dfbce46623f8b63dfd7dfa
- git_dirty: True
- worktree_fingerprint: 68d8c9ec0073f1a295f4cc4015d31837f327794f12622f407c7494e0bc7fa7e6
...
|--|--|--|--|--|--|--:|--:|--:|--:|--:|--:|--:|--:|--|--|--|
|ac-rag|6b7bb428e1|f26efbb61f|L|daemon|daemon|3|3|0|0|0.411|0.487|2.000|0.487|INSUFFICIENT_N|PASS|YES|
|incident-rag|7e3858deb3|f825401fbe|L|daemon|daemon|3|3|0|0|0.425|0.457|2.000|0.457|INSUFFICIENT_N|PASS|YES|
|rfc-full-20k-rag|c7f4fba2fc|7c2a9d6f17|L|daemon|daemon|3|3|0|0|0.608|0.878|2.000|0.878|INSUFFICIENT_N|PASS|YES|
...
|--|--|--|--|--:|--|--|
|MAC-RFC-NOHIT|rfc-full-20k-rag|L|daemon|0.878|partial|rfc10002.txt|
|MAC-RFC-EXACT-N|rfc-full-20k-rag|L|daemon|0.608|partial|rfc10002.txt|
|MAC-AC-EXACT-N|ac-rag|L|daemon|0.487|partial|iea_2018_the_future_of_cooling.pdf|
|MAC-RFC-EXACT-P|rfc-full-20k-rag|L|daemon|0.484|ok|rfc10002.txt|
|MAC-INC-EXACT-P|incident-rag|L|daemon|0.457|ok|ntsb_aviation_report_67438.pdf|
|MAC-INC-NOHIT|incident-rag|L|daemon|0.425|partial|ntsb_aviation_report_67438.pdf|
|MAC-AC-NOHIT|ac-rag|L|daemon|0.411|partial|sample_global_cooling_temperature_memo.docx|
|MAC-INC-EXACT-N|incident-rag|L|daemon|0.411|partial|ntsb_aviation_report_67438.pdf|
|MAC-AC-EXACT-P|ac-rag|L|daemon|0.402|ok|SOURCES.md|
