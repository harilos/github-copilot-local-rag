# RAG性能評価ダッシュボード 20260726-mac-short-contract9-clean
...
|--:|--|--|--|--|--:|--:|--:|--:|--|--|
|1|Current compatible run|9ec0213cc4|a6c0d6f965|seq=default, explain=False, diag=basic, pure=False|9|9|0|0.560|INSUFFICIENT_N|PASS|

## Run 1: Current compatible run

- source/run_id: 20260726-mac-short-contract9-clean
...
|--|--|--|--|--|--|--:|--:|--:|--:|--:|--:|--:|--:|--|--|--|
|ac-rag|6b7bb428e1|f26efbb61f|L|daemon|daemon|3|3|0|0|0.450|0.560|2.000|0.560|INSUFFICIENT_N|PASS|YES|
|incident-rag|7e3858deb3|f825401fbe|L|daemon|daemon|3|3|0|0|0.454|0.466|2.000|0.466|INSUFFICIENT_N|PASS|YES|
|rfc-full-20k-rag|c7f4fba2fc|7c2a9d6f17|L|daemon|daemon|3|3|0|0|0.405|0.478|2.000|0.478|INSUFFICIENT_N|PASS|YES|
...
|--|--|--|--|--:|--|--|
|MAC-AC-EXACT-P|ac-rag|L|daemon|0.560|ok|SOURCES.md|
|MAC-RFC-EXACT-N|rfc-full-20k-rag|L|daemon|0.478|partial|rfc10002.txt|
|MAC-INC-NOHIT|incident-rag|L|daemon|0.466|partial|ntsb_aviation_report_67438.pdf|
|MAC-INC-EXACT-P|incident-rag|L|daemon|0.454|ok|ntsb_aviation_report_67438.pdf|
|MAC-AC-EXACT-N|ac-rag|L|daemon|0.450|partial|iea_2018_the_future_of_cooling.pdf|
|MAC-RFC-EXACT-P|rfc-full-20k-rag|L|daemon|0.405|ok|rfc10002.txt|
|MAC-AC-NOHIT|ac-rag|L|daemon|0.404|partial|sample_global_cooling_temperature_memo.docx|
|MAC-INC-EXACT-N|incident-rag|L|daemon|0.403|partial|ntsb_aviation_report_67438.pdf|
|MAC-RFC-NOHIT|rfc-full-20k-rag|L|daemon|0.396|partial|rfc10002.txt|
