# RAG性能評価ダッシュボード 20260726-mac-short-postfix-coldwarm-ac
...
|--:|--|--|--|--|--:|--:|--:|--:|--|--|
|1|Current pure-profile|9ec0213cc4|afcddd845d|seq=default, explain=False, diag=off, pure=True|2|2|0|0.521|INSUFFICIENT_N|PASS|

## Run 1: Current pure-profile

- source/run_id: 20260726-mac-short-postfix-coldwarm-ac
...
- case_spec_fingerprint: 5a8b3e9a3e780bbd8a5a740f95b38abb2ee2b3bc23be671c4d61172e5a838439
...
|--|--|--|--|--|--|--:|--:|--:|--:|--:|--:|--:|--:|--|--|--|
|ac-rag|6b7bb428e1|f26efbb61f|H|daemon|daemon|2|2|0|0|0.377|0.521|8.000|0.521|INSUFFICIENT_N|PASS|YES|
...
|--|--|--|--|--:|--|--|
|MAC-AC-NOHIT|ac-rag|H|daemon|0.521|ok|sample_global_cooling_temperature_memo.docx|
|MAC-AC-NOHIT|ac-rag|H|daemon|0.377|ok|sample_global_cooling_temperature_memo.docx|
