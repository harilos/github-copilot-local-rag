# RAG性能評価ダッシュボード 20260726-mac-short-nodaemon3
...
|--:|--|--|--|--|--:|--:|--:|--:|--|--|
|1|Current pure-profile|9ec0213cc4|cd82614c79|seq=default, explain=False, diag=off, pure=True|3|0|3||NOT_RUN|NOT_RUN|

## Run 1: Current pure-profile

- source/run_id: 20260726-mac-short-nodaemon3
...
|--|--|--|--|--:|--|--|
|AC_SEM_001|ac-rag|H|no-daemon|16.048|timeout||
|RFC_SEM_001|rfc-full-20k-rag|H|no-daemon|16.033|timeout||
|INC_SEM_001|incident-rag|H|no-daemon|16.019|timeout||
