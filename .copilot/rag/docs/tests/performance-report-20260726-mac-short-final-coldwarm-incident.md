# RAG性能評価ダッシュボード 20260726-mac-short-final-coldwarm-incident
...
|--:|--|--|--|--|--:|--:|--:|--:|--|--|
|1|Current pure-profile|9ec0213cc4|68d8c9ec00|seq=default, explain=False, diag=off, pure=True|2|2|0|0.821|INSUFFICIENT_N|PASS|

## Run 1: Current pure-profile

- source/run_id: 20260726-mac-short-final-coldwarm-incident
...
|--|--|--|--|--|--|--:|--:|--:|--:|--:|--:|--:|--:|--|--|--|
|incident-rag|7e3858deb3|f825401fbe|H|daemon|daemon|2|2|0|0|0.660|0.821|8.000|0.821|INSUFFICIENT_N|PASS|YES|
...
|--|--|--|--|--:|--|--|
|INC_SEM_001|incident-rag|H|daemon|0.821|ok|ntsb_aviation_report_67526.pdf|
|INC_SEM_001|incident-rag|H|daemon|0.660|ok|ntsb_aviation_report_67526.pdf|
