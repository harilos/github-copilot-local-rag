# RAG性能評価ダッシュボード 20260726-mac-short-final-v4-coldwarm-ac
...
|--:|--|--|--|--|--:|--:|--:|--:|--|--|
|1|Current pure-profile|9ec0213cc4|0d54579cec|seq=default, explain=False, diag=off, pure=True|2|2|0|0.514|INSUFFICIENT_N|PASS|

## Run 1: Current pure-profile

- source/run_id: 20260726-mac-short-final-v4-coldwarm-ac
- git_commit: 9ec0213cc48eb5ca63dfbce46623f8b63dfd7dfa
- git_dirty: True
- worktree_fingerprint: 0d54579cece9bd736633ea30d3c9a93b049f9fd1c55071b69bf4ed61a1d97900
...
|--|--|--|--|--|--|--:|--:|--:|--:|--:|--:|--:|--:|--|--|--|
|ac-rag|6b7bb428e1|f26efbb61f|H|daemon|daemon|2|2|0|0|0.382|0.514|8.000|0.514|INSUFFICIENT_N|PASS|YES|
...
|--|--|--|--|--:|--|--|
|AC_SEM_001|ac-rag|H|daemon|0.514|ok|sample_global_cooling_temperature_memo.docx|
|AC_SEM_001|ac-rag|H|daemon|0.382|ok|sample_global_cooling_temperature_memo.docx|
