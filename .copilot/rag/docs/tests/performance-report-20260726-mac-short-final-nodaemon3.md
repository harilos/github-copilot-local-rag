# RAG性能評価ダッシュボード 20260726-mac-short-final-nodaemon3
...
|--:|--|--|--|--|--:|--:|--:|--:|--|--|
|1|Current pure-profile|9ec0213cc4|68d8c9ec00|seq=default, explain=False, diag=off, pure=True|3|3|0|5.355|NOT_RUN|NOT_RUN|

## Run 1: Current pure-profile

- source/run_id: 20260726-mac-short-final-nodaemon3
...
|--|--|--|--|--|--|--:|--:|--:|--:|--:|--:|--:|--:|--|--|--|
|ac-rag|6b7bb428e1|f26efbb61f|H|no-daemon|no-daemon|1|1|0|0|5.355|5.355|8.000|5.355|INSUFFICIENT_N|PASS|YES|
|incident-rag|7e3858deb3|f825401fbe|H|no-daemon|no-daemon|1|1|0|0|4.628|4.628|8.000|4.628|INSUFFICIENT_N|PASS|YES|
|rfc-full-20k-rag|c7f4fba2fc|7c2a9d6f17|H|no-daemon|no-daemon|1|1|0|0|4.965|4.965|8.000|4.965|INSUFFICIENT_N|PASS|YES|
...
|JSON stdout purity|PASS|3|3|0|0|完了行のみを分母にする|
|全検索の正常完了率|PASS|3|3|0|0|exit 0・JSON parse・payload errorなし|
...
|diagnostics mode contract|PASS|3|3|0|0|応答実値と要求値を照合|
...
|outer deadline adherence|PASS|3|3|0|0|成功・失敗を問わずwall time ≤ 15.000 sec|
...
|no-daemon smoke|PASS|3|3|0|0|N=0はNOT_RUN|
...
|Gate|N|Pass|Fail|
|--|--:|--:|--:|
|JSON stdout parse|3|3|0|
|stdout JSON purity|3|3|0|
...
|--|--|--|--|--:|--|--|
|AC_SEM_001|ac-rag|H|no-daemon|5.355|ok|sample_global_cooling_temperature_memo.docx|
|RFC_SEM_001|rfc-full-20k-rag|H|no-daemon|4.965|ok|rfc10026.txt|
|INC_SEM_001|incident-rag|H|no-daemon|4.628|ok|ntsb_aviation_report_67526.pdf|
