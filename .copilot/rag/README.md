...
## Direct CLI lookup boundary

The diagnostic read-only CLI has two public entry points. The custom Agents use
the MCP tools above instead of invoking these scripts directly:
