...
class WindowsOfflineDistributionContracts(unittest.TestCase):
    ...
    def test_readmes_describe_slash_skill_and_approval_boundary(self) -> None:
        ...
        self.assertIn("selection defaults to Individual", combined)
        self.assertIn("runner approval is VS Code only", combined)
        self.assertIn("Copilot CLI global approval requires separate CLI permission", combined)
